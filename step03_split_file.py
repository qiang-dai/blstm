...
def args():
    ...
    result_dir = 'raw_data/dir_step03'
    if len(sys.argv) > 3:
        res_file = sys.argv[3]
...
if __name__ == '__main__':
    ...
    for file_index, filename in enumerate(filename_list):
        ...
        for i in range(parts+1):
            ...
            dst_filename = result_dir + '/data_%02d_%02d_%s.txt'%(file_index, i, shortname)

            ###数量要大于一批次
            if len(sentences[begin:end]) > 500:
